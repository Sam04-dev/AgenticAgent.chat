# Project Irrelevance & Deviation Report (AGENTICAGENT.CHAT v2.0.0)
...
- **Manual Interfaces**: `src/logic/types.ts` contains manually defined interfaces for `TaskIntent` and `ValidationArtifact`, which duplicates the source of truth in `.specify/spec/*.yaml`.
